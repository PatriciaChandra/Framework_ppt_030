...
class RoutingTest extends TestCase
{
    public function testGet()
    {
        $this->get('/pzn')
            ->assertStatus(200)
            ->assertSeeText('Hello Cia_chandra');
    }
    ...
    {
        $this->get('/tidakada')
            ->assertSeeText('404 by Cia_chandra');
    ...
    public function testRouteParameterRegex()
    {
        ...
        $this->get('/categories/Patricia')
            ->assertSeeText('404 by Cia_chandra');
    }

    public function testRouteParameterOptional()
    {
        $this->get('/users/Patricia')
            ->assertSeeText('User Patricia');
    ...
    public function testRouteConflict()
    {
        ...
        $this->get('/conflict/Patricia')
            ->assertSeeText("Conflict Patricia");
    }
