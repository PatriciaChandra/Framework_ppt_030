...
Route::get('/pzn', function () {
    return "Hello Cia_chandra";
});

Route::redirect('/youtube', '/pzn');

Route::fallback(function () {
    return "404 by Cia_chandra";
});

Route::view('/hello', 'hello', ['name' => 'Patricia']);

Route::get('/hello-again', function () {
    return view('hello', ['name' => 'Patricia']);
});

Route::get('/hello-world', function () {
    return view('hello.world', ['name' => 'Patricia']);
});
...
Route::get('/conflict/Patricia', function () {
    return "Conflict Patricia chandra Eka candra";
});
...
Route::get('/redirect/named', function () {
    return \Illuminate\Support\Facades\URL::route('redirect-hello', ['name' => 'Patricia']);
});
